...
public class BofACCAdapter implements ICCAdapter {
	...
	public BofACCAdapter() {
		System.out.println("Bank Of America");
	}


	private void getCustomerName() {
		System.out.print("Enter Name on CC: ");
	...
	private void getCCN() {
		do {
			...
			System.out.print("Ex. 1234-5678-9876-5432: ");
	...
	private void getExpirationDate() {
		do {
			System.out.print("Enter Credit Card Expiration Date (MM/YYYY):");
